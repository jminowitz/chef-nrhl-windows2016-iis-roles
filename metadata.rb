...
#
# issues_url 'https://github.com/<insert_org_here>/chef-nrhl-windows2016-iis-roles/issues'

# The `source_url` points to the development repository for this cookbook.  A
# `View Source` link will be displayed on this cookbook's page when uploaded to
# a Supermarket.
#
# source_url 'https://github.com/<insert_org_here>/chef-nrhl-windows2016-iis-roles'
